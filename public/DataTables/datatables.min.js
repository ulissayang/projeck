 ...
 *   https://datatables.net/download/#bs5/dt-2.0.8/fh-4.0.1/r-3.0.2
 *
 * Included libraries:
 *   DataTables 2.0.8, FixedHeader 4.0.1, Responsive 3.0.2
 */
            ...
            (($.ext = C =
                {
                    buttons: {},
                    classes: {},
                    builder: "bs5/dt-2.0.8/fh-4.0.1/r-3.0.2",
                    errMode: "alert",
                    feature: [],
                    features: {},
                    search: [],
        ...
        be =
            ...
            ($.defaults = {
                ...
                oLanguage: {
                    ...
                    sDecimal: "",
                    sThousands: ",",
                    sLengthMenu: "_MENU_ _ENTRIES_ per hal",
    ...
    return (
        b.extend(s.prototype, {
            ...
            _stickyPosition: function (t, e) {
                ...
                this._scrollEnabled() &&
                    ((i =
                        "rtl" === b(this.s.dt.table().node()).css("direction")),
            ...
            _modeChange: function (t, e, o) {
                ...
                ("footer" === e && c) ||
                    ((i = function (t) {
                        h.floating[0].style.setProperty(
                            "width",
                            t + "px",
                            "important"
                        ),
                    ...
                    (s = b.contains(n[0], v.activeElement)
                        ? v.activeElement
                        : null),
                ...
                this.s.dt.settings()[0].bDestroying ||
                    ...
                    this.c.header &&
                        ...
                        d + this.c.headerOffset + l.theadHeight <= c
                            ...
                            : (r = "below"),
                        (!t && r === this.s.headerMode) ||
                            this._modeChange(r, "header", t),
                    ...
                    this.c.footer &&
                        ...
                        l.tfootBottom + this.c.footerOffset <= n
                            ...
                            ? ((u = "in"), (t = !0))
                            : (u = "above"),
                        (!t && u === this.s.footerMode) ||
                            this._modeChange(u, "footer", t),
                    ...
                    void 0 !== this.s.dt.settings()[0]._fixedColumns &&
                        ((this.dom.header.rightBlocker = (u = function (
                            t,
                            e,
                            o
                        ) {
            ...
            (b.extend(a.prototype, {
                ...
                _childNodesRestore: function (e, t, n) {
                    ...
                    if (this.s.childNodeStore[i]) {
                        ...
                        if (0 < e.length) {
                            for (
                                var o = e[0].parentNode.childNodes,
                                    s = [],
                                    d = 0,
                                    a = o.length;
                                d < a;
                ...
                _classLogic: function () {
                    function d(e, t, n, i) {
                        ...
                        if (n) {
                            if ("max-" === n)
                                for (
                                    r = a._find(t).width, o = 0, s = l.length;
                                    o < s;
                                    o++
                                )
                    ...
                    r
                        ...
                        .each(function (e, t) {
                            r.column(e).visible() &&
                                ...
                                c[t]
                                    ? i._colGroupAttach(m, v, t)
                                    : v[t].detach());
                        }),
                        h &&
                            (r.columns.adjust(),
                            this._redrawChildren(),
                            b(r.table().node()).trigger(
                        ...
                        t.rows({ page: "current" }).every(function (n) {
                            ...
                            e &&
                                ...
                                t.cells(n, o).every(function (e, t) {
                                    ...
                                    (t
                                        ? b(this.node().cloneNode(!1)).append(
                                              b(t).clone()
                                          )
                                        : b(this.node()).clone(!1)
                                    ).appendTo(i);
