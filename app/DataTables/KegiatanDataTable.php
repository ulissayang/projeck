        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('aksi', function ($data) {
                return sprintf(
                    ...
                    route('kegiatan.show', $data->slug),
                    $data->slug, // slug attribute for edit button
                    $data->slug, // slug attribute for delete button
                    $data->id,
                    route('kegiatan.edit', $data->slug),
                    // route('kegiatan.destroy', $data->slug),
                    method_field('DELETE'),
                    csrf_field()
                );
            })
        ...
        return [
            Column::computed('checkbox')
                ...
                ->render(function ($data) {
                    ...
                    if ($data instanceof \App\Models\Kegiatan && property_exists($data, 'id')) {
