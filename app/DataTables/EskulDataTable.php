...
class EskulDataTable extends DataTable
{
    /**
     ...
     */
    public function query(Eskul $model)
    {
        ...
        return [
            Column::computed('checkbox')
                ...
                ->render(function ($data) {
                    // Jika $data adalah objek eskul dan memiliki properti 'id'
                    if ($data instanceof Eskul && property_exists($data, 'id')) {
            ...
            Column::make('eskul')->title('Eskul'),
            Column::make('hari')->title('Hari'),
            Column::make('pendamping')->title('Pendamping'),
