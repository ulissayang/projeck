          ...
          <div class="card">
            <div class="card-body ">
              <div class="card-title">
                <x-button as="a" :href="route('prestasi.create')" class="btn-sm" title="Tambah Data">
              ...
              <table class="table table-striped datatable table-responsive table-hover ">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ (new \Carbon\Carbon($data->date))->format('d F Y') }}</td>
                    <td>
                      <x-button as="a" :href="route('prestasi.show', $data->slug)" class="btn-sm btn-success"
                        title="Lihat"><i class="bi bi-eye"></i>
                      </x-button>

                      <x-button as="a" :href="route('prestasi.edit', $data->slug)" class="btn-sm btn-warning"
                        title="Sunting"><i class="bi bi-pencil-square"></i>
                      </x-button>


                      <form action="{{ route('prestasi.destroy', $data->id) }}" method="post" class="d-inline">
                        @method('delete')
                        @csrf
                        <button class="btn-sm btn btn-danger"
                          onclick="return confirm('Anda yakin ingin menghapus data ini ?')" title="Hapus"><i
