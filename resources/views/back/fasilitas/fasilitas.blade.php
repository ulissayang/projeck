<x-app-layout>
    ...
    <main id="main" class="main">
        ...
        <section class="section">
                    ...
                    <div class="card">
                        <div class="card-body overflow-x-auto">
                            ...
                            <form id="bulk-delete-form" action="#" method="POST"
                                data-url="{{ route('fasilitas.bulk_delete') }}" style="display: none;">
                                @csrf
                                @method('DELETE')
            ...
            @include('back.fasilitas.fasilitas-form')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\FasilitasRequest', '#modalForm') !!}
    ...
    <script>
        ...
        var bulkDeleteUrl = "{{ route('fasilitas.bulk_delete') }}";
