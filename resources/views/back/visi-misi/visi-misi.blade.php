<x-app-layout>
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      ...
      @include('back.visi-misi.visi-misi-form')
  ...
  {!! JsValidator::formRequest('App\Http\Requests\VisiMisiRequest', '#modalForm') !!}
