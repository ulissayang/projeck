          ...
          <div class="card">
            <div class="card-body ">
              <div class="card-title">
                <x-button as="a" :href="route('galery-foto.create')" class="btn-sm" title="Tambah Data">
              ...
              <table class="table table-striped datatable table-responsive table-hover ">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <x-button as="a" :href="route('galery-foto.show', $data->slug)" class="btn-sm btn-success"
                        title="Lihat"><i class="bi bi-eye"></i>
                      </x-button>
                      <x-button as="a" :href="route('galery-foto.edit', $data->slug)" class="btn-sm btn-warning"
                        title="Sunting"><i class="bi bi-pencil-square"></i>
                      </x-button>

                      {{-- form delete post --}}
                      <form action="{{ route('galery-foto.destroy', $data->id) }}" method="post" class="d-inline">
                        @method('delete')
                        @csrf
