          ...
          <div class="card">
            <div class="card-body ">
              <div class="card-title">
                <x-button as="a" :href="route('guru.create')" class="btn-sm" title="Tambah Data">
              ...
              <table class="table table-striped datatable table-responsive table-hover ">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <x-button as="a" :href="route('guru.show', $data->slug)" class="btn-sm btn-success" title="Lihat">
                        <i class="bi bi-eye"></i>
                      </x-button>
                      <x-button as="a" :href="route('guru.edit', $data->slug)" class="btn-sm btn-warning"
