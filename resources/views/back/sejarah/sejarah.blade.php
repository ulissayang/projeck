<x-app-layout>
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      ...
      @include('back.sejarah.sejarah-form')
  ...
  {!! JsValidator::formRequest('App\Http\Requests\SejarahRequest', '#modalForm') !!}
